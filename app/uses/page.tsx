...
export const metadata: Metadata = {
  title: "Uses",
  description: "The tools and hardware I use day to day.",
};
    ...
    <>
      ...
      <article className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <ul>
          ...
          <li>
            <strong>Logitech Signature M650</strong> &mdash; Silent and precise.
          </li>
          <li>
            <strong>Keychron V4 QMK</strong> &mdash; Customizable with a tactile
            mechanical feel.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            <strong>Aerospace</strong> &mdash; Simple yet efficient macOS tiling
            window manager.
          </li>
        </ul>
