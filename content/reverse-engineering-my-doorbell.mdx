...
<Figure caption="The dashboard of the web replacement. Device status, plan counters, and the two actions I use every day.">
  <Image
    src="/blog/reverse-engineering-my-doorbell/threshold-screenshot.png"
...
<Figure caption="Login, dashboard, and live view end-to-end. The feed runs for ~30 seconds, the server ends the session, and the client reconnects automatically.">
  <video
    src="/blog/reverse-engineering-my-doorbell/live-session.mp4"
    controls
    playsInline
    muted
    preload="metadata"
...
<Figure caption="Two broadcasts picked up on srv01 within a second of each other. Neither of these sessions was started by me.">
  <Image
    src="/blog/reverse-engineering-my-doorbell/audit-dashboard.png"
...
<Figure caption="Probe result with privacy mode on. The server answered — the payload is redacted here, but the response itself is the signal.">
  <Image
    src="/blog/reverse-engineering-my-doorbell/audit-probe.png"
...
<Figure caption="The audit flow end-to-end. Privacy mode keeps the IDs masked. The click happens at the end; the panel camera follows about a second later.">
  <video
    src="/blog/reverse-engineering-my-doorbell/audit-flow.mp4"
    controls
    playsInline
    muted
    preload="metadata"
